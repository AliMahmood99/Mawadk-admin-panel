...
export default function EditCategoryPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await CategoriesService.updateCategory(id, formData);
  ...
  return (
    <DashboardLayout requiredUserType="admin">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900">{t("editCategory")}</h1>
          <p className="text-slate-500 mt-1">{t("editCategoryDesc")}</p>
        </div>
      </div>
            ...
            <Card className="border-slate-200">
              ...
              <CardContent>
                <div className="space-y-4">
                  {/* Image Preview */}
                  <div
                    className="relative aspect-square rounded-xl border-2 border-dashed border-slate-200 bg-slate-50 hover:border-primary hover:bg-primary/5 transition-colors flex items-center justify-center overflow-hidden cursor-pointer"
