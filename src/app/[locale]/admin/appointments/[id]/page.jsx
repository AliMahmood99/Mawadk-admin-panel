    ...
    return (
      <DashboardLayout requiredUserType="admin">
        <div className="flex flex-col items-center justify-center min-h-[60vh]">
          ...
          <Button
            variant="outline"
            onClick={() => router.push(`/${locale}/admin/appointments`)}
            className="gap-2"
          >
    ...
    <DashboardLayout requiredUserType="admin">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          {/* Provider / Doctor Info - Different display based on provider type */}
          {booking.provider?.type === "Doctor" ? (
            // Doctor type - Doctor info is in provider directly
            <Card className="border-slate-200 overflow-hidden">
            ...
            // Hospital or Clinic type - Provider info + Doctor info separate
            <>
              <Card className="border-slate-200 overflow-hidden">
                <CardHeader className="bg-blue-50 border-b border-blue-200 pb-4">
                  <CardTitle className="text-base font-semibold flex items-center gap-2 text-blue-700">
                    ...
                    {booking.provider?.type === "Hospital" ? t("hospital") || "Hospital" : t("clinic") || "Clinic"}
                  </CardTitle>
                </CardHeader>
                <CardContent className="p-6">
                  {booking.provider && (
