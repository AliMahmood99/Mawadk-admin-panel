...
3. If you need only the changed files for mobile apps in V11.0 check the update files in update files for apps from V10.2 to V11.0 folder. Please try to run this change log folder. 
